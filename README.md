...
- **Для Windows 11:**
  ...
  - _Або:_ Зайдіть у бібліотеку вашого Steam, знайдіть Call of Cthulhu, натисніть на шестерню справа гри > `Управління` > `Локальні файли` і у вас відкриється потрібна тека гри. Якщо ж ви не знаходите таку опцію в налаштуваннях всередині Steam, то виконайте наступний крок нижче..
